...
function buttonColor(curr_div) {
    if (curr_div.id == "all"){
        curr_div.className = "red-box shapeAllBox";
        ...
        document.getElementById("all").className = "grey-box shapeAllBox";
...
function htmlForDevice(device){

    
    longString = "";
    longString += "<td class='text-with-device'> <img src=" + device.img + " class=" + device.classs + " height=80 width=80 /> ";
